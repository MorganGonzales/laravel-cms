<div class="p-6">
            ...
            <div class="py-2 align-middle inline-block min-w-full">
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table class="w-full divide-y divide-gray-200">
                        <thead>
                        <tr>
                            <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray500 uppercase tracking-wider">Type</th>
                            <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray500 uppercase tracking-wider">Sequence</th>
                            <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray500 uppercase tracking-wider">Label</th>
                            <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray500 uppercase tracking-wider">Url</th>
                            <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray500 uppercase tracking-wider"></th>
                        </tr>
                        </thead>
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td class="px-6 py-2 flex justify-end">
                                            ...
                                            <x-jet-danger-button wire:click="deleteShowModal({{ $item->id }})" class="ml-2">
                                                {{ __('Delete') }}
                                            </x-jet-danger-button>
                                        </td>
                                    </tr>
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                ...
                <div class="mt-1 flex rounded-md shadow-sm">
                    ...
                    <x-jet-input wire:model="slug" id="slug" class="form-input flex-1 block w-full rounded-none rounded-r-md transition duration-150 ease-in-out sm:text-sm sm:leading-5" type="text" placeholder="url-slug" />
                </div>
    ...
    <x-jet-dialog-modal wire:model="modalConfirmDeleteVisible">
        ...
        <x-slot name="content">
            {{ __('Are you sure you want to delete navigation item?') }}
        </x-slot>
